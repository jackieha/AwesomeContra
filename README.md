...
一款横版跑射（run-and-gun）像素动作游戏，实现形态为**微信小游戏**，另有 H5 宿主用于开发与 CI。
...
| 文档 | 内容 |
|---|---|
| [`docs/design.md`](docs/design.md) | **主规范**：合规前提、宿主架构、显示规范、玩法机制细则、性能预算、测试策略、路线图、常量表 |
...
| [`docs/adr/0002-minigame-vs-miniprogram.md`](docs/adr/0002-minigame-vs-miniprogram.md) | 为什么实现形态是小游戏，以及为什么普通小程序宿主保留但不实现 |
